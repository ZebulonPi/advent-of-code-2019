...
namespace AdventOfCode2019
{
    public class Day_2
    {
        ...
        {
            string text = System.IO.File.ReadAllText(@"/Users/jasongreenwood/advent-of-code-2019/AdventOfCode2019/AdventOfCode2019/Day_2_input.txt");
            ...
            int ans = RunComputation(numbers);
        ...
        public static void Part_2()
        {
            ...
            for (int first = 0; first < 100; first++)
            {
                for (int second = 0; second < 100; second++)
                {
                    ...
                    Console.WriteLine("first and second are:" + first + "," + second);

                    ans = RunComputation(numbers);
